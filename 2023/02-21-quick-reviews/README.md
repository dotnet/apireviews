# API Review 02/21/2023

## Add Decimal32, Decimal64, and Decimal128 from the IEEE 754-2019 standard.

**Approved** | [#runtime/81376](https://github.com/dotnet/runtime/issues/81376#issuecomment-1438909827)
...
```
## Make it easier to create quality ValidateOptionsResult instances

**Approved** | [#runtime/77404](https://github.com/dotnet/runtime/issues/77404#issuecomment-1438963979)
...
```
## Add a type to represent IP networks based on CIDR notation

**Approved** | [#runtime/79946](https://github.com/dotnet/runtime/issues/79946#issuecomment-1438985842)

* We changed the mask length from `byte` to `int`.
* Since this type doesn't support custom formatting, the ToString/TryFormat/Parse/TryParse methods should be explicit interface implementations and have public exposure without the format/provider arguments.
* Based on IPv6 / CIDR calling it "prefix" vs "mask", we've changed `maskLength` to `prefixLength`
...
public readonly struct IPNetwork : IEquatable<IPNetwork>, ISpanFormattable, ISpanParsable<IPNetwork>
{
    ...
    string ISpanFormattable<IPNetwork>.ToString(string? format, IFormatProvider? provider = null);
...
```
## Developers can safely trim apps which need Configuration Binder

**NeedsWork** | [#runtime/44493](https://github.com/dotnet/runtime/issues/44493#issuecomment-1439044346)
